...
2) Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/ayaba25/mvn-nesux101/blob/main/jenkins-install.sh
    - Launch Instance
...
3) SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/ayaba25/mvn-nesux101/blob/main/sonarqube-install.sh
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data):https://github.com/ayaba25/mvn-nesux101/blob/main/nexus-install.sh
    - Launch Instance
...
// use the code below to install maven on ec2
